...
func scheduleApp(t *testing.T, ident authn.Identity, events event.Store, seasons season.Store) *fiber.App {
	...
	app.Get("/v1/events/:id", eh.Get)
	app.Delete("/v1/events/:id", eh.Delete)
	app.Post("/v1/events/:id/restore", eh.Restore)
	app.Get("/v1/seasons", sh.List)
	app.Post("/v1/seasons", sh.Create)
	app.Get("/v1/seasons/:id", sh.Get)
	app.Delete("/v1/seasons/:id", sh.Delete)
	app.Post("/v1/seasons/:id/restore", sh.Restore)
	...
	app.Get("/v1/event-days/:id", sch.GetDay)
	app.Delete("/v1/event-days/:id", sch.DeleteDay)
	app.Post("/v1/event-days/:id/restore", sch.RestoreDay)
