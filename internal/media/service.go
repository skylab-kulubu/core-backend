...
type Service interface {
	...
	// core purpose, the admin being the actor (onBehalfOf empty). Every link
	// is written to the access log.
	IssueReadLink(ctx context.Context, p authz.Principal, id, onBehalfOf uuid.UUID) (ReadLink, error)
